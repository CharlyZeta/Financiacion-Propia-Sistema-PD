            ...
            <div class="cxd-product-grid">
                <?php while ( $products_query->have_posts() ) : $products_query->the_post(); ?>
                    <?php
                        ...
                        // El texto se pasa sin codificar a data-text; el JS hará encodeURIComponent() una sola vez.
                    ...
                    <div class="cxd-product-card">
                        ...
                        <div class="cxd-card-content">
                            ...
                            <div class="cxd-card-actions">
                                ...
                                <a class="cxd-action-whatsapp" title="Compartir por WhatsApp" data-text="<?php echo esc_attr($whatsapp_text); ?>" target="_blank">
