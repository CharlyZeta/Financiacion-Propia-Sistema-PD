            ...
            <div class="cxd-product-grid">
                <?php while ( $products_query->have_posts() ) : $products_query->the_post(); ?>
                    <?php
                        ...
                        $whatsapp_text .= "*Precio de Lista:* " . $precio_venta_limpio . "\n";
                        ...
                        if ($descuento_transferencia > 0) {
                            ...
                            $whatsapp_text .= "*Abonando con Transferencia:* " . $precio_transferencia_limpio . "\n";
                        }
                        if (!empty($planes)) { 
                            $whatsapp_text .= "*Planes de Pago por Día:*\n"; 
                        ...
                        // Los saltos de línea reales se normalizan a espacios en atributos HTML.
                        // Se reemplazan por la secuencia literal \n para preservarlos; el JS los restaurará.
                        $whatsapp_text_for_attr = str_replace("\n", '\n', $whatsapp_text);
                    ...
                    <div class="cxd-product-card">
                        ...
                        <div class="cxd-card-content">
                            ...
                            <div class="cxd-card-actions">
                                ...
                                <a class="cxd-action-whatsapp" title="Compartir por WhatsApp" data-text="<?php echo esc_attr($whatsapp_text_for_attr); ?>" target="_blank">
